        ...
        <div class="row">             
            ...
            <div class="col-7 col-sm-5">
                ...
                <address class="address">
                    ...
                    Chandigarh<br>
                    India<br>
                    <i class="fa fa-phone-alt fa-lg"></i> : +91-0172-4190419<br>
                    <i class="fa fa-phone-alt fa-lg"></i> : +91-7888823456<br>
                    <i class="far fa-envelope fa-lg"></i> :
                    <a href="mailto:confusion@food.net">customercare@onlinestore.com</a>
                </address>
            </div>
            <div class="col-12 col-sm-4 align-self-center">
                    <div class="text-center">
                        ...
                        <a class="btn btn-social-icon btn-instagram" href="http://youtube.com/">
                                <i class="fab fa-instagram"></i></a>
                                
                        <a class="btn btn-social-icon btn-github" href="http://youtube.com/">
